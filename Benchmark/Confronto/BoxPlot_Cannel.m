...
data_claudio1 = data_claudio(:, 1);
data_claudio2 = data_claudio(:,2);
data_claudio3 = data_claudio(:,3); 
...
%figure; 
%boxplot([data_claudio1])


[h, p, ci, stats] = ttest2(data_claudio1, data_mauro1, 'Vartype', 'unequal');
...
[h, p, ci, stats] = ttest2(data_claudio2, data_mauro2, 'Vartype', 'unequal');
...
% figure;
% 
% % Boxplot per la varianza tra data_claudio1 e data_mauro1
% subplot(3, 1, 1);
% boxplot([data_claudio1, data_mauro1], 'Labels', {'Claudio', 'Mauro1'});
% title('Confronto Varianza - Colonna 1');
% 
% % Boxplot per la varianza tra data_claudio2 e data_mauro2
% subplot(3, 1, 2);
% boxplot([data_claudio2, data_mauro2], 'Labels', {'Claudio', 'Mauro2'});
% title('Confronto Varianza - Colonna 2');
% 
% % Boxplot per la varianza tra data_claudio3 e data_mauro3
% subplot(3, 1, 3);
% boxplot([data_claudio3, data_mauro3], 'Labels', {'Claudio', 'Mauro3'});
